...
void WriteLED(uint32_t ledId, uint8_t ledState)
{
    ...
    /**enable le */
    HAL_GPIO_WritePin(MCU_MAIN_EN_POINT_LED_GPIO_Port, MCU_MAIN_EN_POINT_LED_Pin, ledId & 0x1UL << 3 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_TB_EN_POINT_LED_GPIO_Port, MCU_TB_EN_POINT_LED_Pin, ledId & 0x1UL << 4 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_DIC1_EN_POINT_LED_GPIO_Port, MCU_DIC1_EN_POINT_LED_Pin, ledId & 0x1UL << 5 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_DIC2_EN_POINT_LED_GPIO_Port, MCU_DIC2_EN_POINT_LED_Pin, ledId & 0x1UL << 6 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_DOC1_EN_POINT_LED_GPIO_Port, MCU_DOC1_EN_POINT_LED_Pin, ledId & 0x1UL << 7 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_DOC2_EN_POINT_LED_GPIO_Port, MCU_DOC2_EN_POINT_LED_Pin, ledId & 0x1UL << 8 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_AIC_EN_POINT_LED_GPIO_Port, MCU_AIC_EN_POINT_LED_Pin, ledId & 0x1UL << 9 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_HIOC1_EN_POINT_LED_GPIO_Port, MCU_HIOC1_EN_POINT_LED_Pin, ledId & 0x1UL << 10 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(MCU_HIOC2_EN_POINT_LED_GPIO_Port, MCU_HIOC2_EN_POINT_LED_Pin, ledId & 0x1UL << 11 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    DelayUs(2);
